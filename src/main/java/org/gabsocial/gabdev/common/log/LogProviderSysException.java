 ...
 */
public class LogProviderSysException extends RuntimeException
{
    
    /**
     * Comment for <code>serialVersionUID</code>
     */
    private static final long serialVersionUID = 4787041236453481343L;
     ...
     */
    public LogProviderSysException(final String message)
    {
     ...
     */
    public LogProviderSysException(final String message, final Throwable throwable)
    {
        super(message, null);
    }
     ...
     *            An instance of <code>Throwable</code>.
     */
    public LogProviderSysException(final Throwable throwable)
    {
